...
create table gtfs_agency (
  ...
  agency_phone text
--, fare_url text
) AS SELECT * FROM CSVREAD('/home/jovyan/work/resources/agency.txt');
...
) AS SELECT * FROM CSVREAD('/home/jovyan/work/resources/stops.txt');
...
)  AS SELECT * FROM CSVREAD('/home/jovyan/work/resources/routes.txt');
...
) AS SELECT * FROM CSVREAD('/home/jovyan/work/resources/calendar.txt');
...
) AS SELECT * FROM CSVREAD('/home/jovyan/work/resources/trips.txt');
...
) AS SELECT * FROM CSVREAD('/home/jovyan/work/resources/stop_times.txt');
